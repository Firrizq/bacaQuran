...
import com.firrizq.myapplication.network.AyahResponse
import com.firrizq.myapplication.network.AyahsItem
import com.firrizq.myapplication.network.SurahResponse
...
class QuranViewModel : ViewModel() {
    ...
    fun getListAyahbySurah(number: Int) {
        ApiConfig.quranApiConfig.getListAyahs(number).enqueue(object : Callback<AyahResponse> {
